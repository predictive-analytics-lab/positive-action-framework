...
def lilliput(*, seed, num_samples, alpha):
    ...
    data["admittance_score"] = (
        ...
        +0.2
        * ((data["essay_bane"] + data["essay_wolf"]) / 2)
    ).round(2)
